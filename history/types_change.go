...
func mapDiscriminatorChange(input interface{}) (Change, error) {
	...
	case "AddAttributeDefinitionChange":
		new := AddAttributeDefinitionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "AddInterfaceInteractionChange":
		new := AddInterfaceInteractionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "AddItemShippingAddressesChange":
		new := AddItemShippingAddressesChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "AddLocalizedEnumValueChange":
		new := AddLocalizedEnumValueChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "AddShippingAddressIdChange":
		new := AddShippingAddressIdChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "AddShoppingListLineItemChange":
		new := AddShoppingListLineItemChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeAmountAuthorizedChange":
		new := ChangeAmountAuthorizedChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeAttributeConstraintChange":
		new := ChangeAttributeConstraintChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeAttributeOrderByNameChange":
		new := ChangeAttributeOrderByNameChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeCustomLineItemQuantityChange":
		new := ChangeCustomLineItemQuantityChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeEnumValueLabelChange":
		new := ChangeEnumValueLabelChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeEnumValueOrderChange":
		new := ChangeEnumValueOrderChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeFieldDefinitionOrderChange":
		new := ChangeFieldDefinitionOrderChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeLineItemQuantityChange":
		new := ChangeLineItemQuantityChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeLocalizedDescriptionChange":
		new := ChangeLocalizedDescriptionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeLocalizedEnumValueLabelChange":
		new := ChangeLocalizedEnumValueLabelChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeLocalizedEnumValueOrderChange":
		new := ChangeLocalizedEnumValueOrderChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangePlainEnumValueLabelChange":
		new := ChangePlainEnumValueLabelChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangePlainEnumValueOrderChange":
		new := ChangePlainEnumValueOrderChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeRequiresDiscountCodeChange":
		new := ChangeRequiresDiscountCodeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeReviewRatingStatisticsChange":
		new := ChangeReviewRatingStatisticsChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeShoppingListLineItemQuantityChange":
		new := ChangeShoppingListLineItemQuantityChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeShoppingListLineItemsOrderChange":
		new := ChangeShoppingListLineItemsOrderChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTaxCalculationModeChange":
		new := ChangeTaxCalculationModeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTaxRoundingModeChange":
		new := ChangeTaxRoundingModeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTextLineItemNameChange":
		new := ChangeTextLineItemNameChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTextLineItemQuantityChange":
		new := ChangeTextLineItemQuantityChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTextLineItemsOrderChange":
		new := ChangeTextLineItemsOrderChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTransactionInteractionIdChange":
		new := ChangeTransactionInteractionIdChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTransactionStateChange":
		new := ChangeTransactionStateChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ChangeTransactionTimestampChange":
		new := ChangeTransactionTimestampChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveAttributeDefinitionChange":
		new := RemoveAttributeDefinitionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveBillingAddressIdChange":
		new := RemoveBillingAddressIdChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveCustomLineItemChange":
		new := RemoveCustomLineItemChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveFieldDefinitionChange":
		new := RemoveFieldDefinitionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveItemShippingAddressesChange":
		new := RemoveItemShippingAddressesChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveLocalizedEnumValuesChange":
		new := RemoveLocalizedEnumValuesChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveParcelFromDeliveryChange":
		new := RemoveParcelFromDeliveryChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveShippingAddressIdChange":
		new := RemoveShippingAddressIdChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "RemoveShoppingListLineItemChange":
		new := RemoveShoppingListLineItemChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetApplicationVersionChange":
		new := SetApplicationVersionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCategoryOrderHintChange":
		new := SetCategoryOrderHintChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemCustomFieldChange":
		new := SetCustomLineItemCustomFieldChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemCustomTypeChange":
		new := SetCustomLineItemCustomTypeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemMoneyChange":
		new := SetCustomLineItemMoneyChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemShippingDetailsChange":
		new := SetCustomLineItemShippingDetailsChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemTaxAmountChange":
		new := SetCustomLineItemTaxAmountChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemTaxCategoryChange":
		new := SetCustomLineItemTaxCategoryChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemTaxRateChange":
		new := SetCustomLineItemTaxRateChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemTaxedPriceChange":
		new := SetCustomLineItemTaxedPriceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomLineItemTotalPriceChange":
		new := SetCustomLineItemTotalPriceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetCustomShippingMethodChange":
		new := SetCustomShippingMethodChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetDefaultBillingAddressChange":
		new := SetDefaultBillingAddressChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetDefaultShippingAddressChange":
		new := SetDefaultShippingAddressChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetDeleteDaysAfterLastModificationChange":
		new := SetDeleteDaysAfterLastModificationChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetDistributionChannelsChange":
		new := SetDistributionChannelsChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemDiscountedPriceChange":
		new := SetLineItemDiscountedPriceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemDiscountedPricePerQuantityChange":
		new := SetLineItemDiscountedPricePerQuantityChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemDistributionChannelChange":
		new := SetLineItemDistributionChannelChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemProductSlugChange":
		new := SetLineItemProductSlugChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemShippingDetailsChange":
		new := SetLineItemShippingDetailsChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemTaxAmountChange":
		new := SetLineItemTaxAmountChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemTaxedPriceChange":
		new := SetLineItemTaxedPriceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLineItemTotalPriceChange":
		new := SetLineItemTotalPriceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetLocalizedDescriptionChange":
		new := SetLocalizedDescriptionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetMaxApplicationsPerCustomerChange":
		new := SetMaxApplicationsPerCustomerChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetMethodInfoInterfaceChange":
		new := SetMethodInfoInterfaceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetOrderLineItemCustomFieldChange":
		new := SetOrderLineItemCustomFieldChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetOrderLineItemCustomTypeChange":
		new := SetOrderLineItemCustomTypeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetParcelMeasurementsChange":
		new := SetParcelMeasurementsChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetParcelTrackingDataChange":
		new := SetParcelTrackingDataChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetProductPriceCustomFieldChange":
		new := SetProductPriceCustomFieldChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetProductPriceCustomTypeChange":
		new := SetProductPriceCustomTypeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetProductVariantKeyChange":
		new := SetProductVariantKeyChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetRestockableInDaysChange":
		new := SetRestockableInDaysChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetReturnPaymentStateChange":
		new := SetReturnPaymentStateChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetReturnShipmentStateChange":
		new := SetReturnShipmentStateChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetShippingInfoPriceChange":
		new := SetShippingInfoPriceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetShippingInfoTaxedPriceChange":
		new := SetShippingInfoTaxedPriceChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetShippingMethodTaxAmountChange":
		new := SetShippingMethodTaxAmountChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetShippingMethodTaxRateChange":
		new := SetShippingMethodTaxRateChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetShippingRateInputChange":
		new := SetShippingRateInputChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetShoppingListLineItemCustomFieldChange":
		new := SetShoppingListLineItemCustomFieldChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetShoppingListLineItemCustomTypeChange":
		new := SetShoppingListLineItemCustomTypeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetStatusInterfaceCodeChange":
		new := SetStatusInterfaceCodeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetStatusInterfaceTextChange":
		new := SetStatusInterfaceTextChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetTextLineItemCustomFieldChange":
		new := SetTextLineItemCustomFieldChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetTextLineItemCustomTypeChange":
		new := SetTextLineItemCustomTypeChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetTextLineItemDescriptionChange":
		new := SetTextLineItemDescriptionChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetValidFromAndUntilChange":
		new := SetValidFromAndUntilChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "SetVariantAvailabilityChange":
		new := SetVariantAvailabilityChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "TransitionCustomLineItemStateChange":
		new := TransitionCustomLineItemStateChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "TransitionLineItemStateChange":
		new := TransitionLineItemStateChange{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
...
type SetShippingRateInputChange struct {
	...
	Change        string                                      `json:"change"`
	NextValue     SetCartClassificationShippingRateInputValue `json:"nextValue"`
	PreviousValue SetCartClassificationShippingRateInputValue `json:"previousValue"`
}
