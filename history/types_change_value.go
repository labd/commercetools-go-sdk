...
func mapDiscriminatorChangeTargetChangeValue(input interface{}) (ChangeTargetChangeValue, error) {
	...
	case "customLineItems":
		new := ChangeTargetCustomLineItemsChangeValue{}
		...
		return new, nil
	case "lineItems":
		new := ChangeTargetLineItemsChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "multiBuyCustomLineItems":
		new := ChangeTargetMultiBuyCustomLineItemsChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "multiBuyLineItems":
		new := ChangeTargetMultiBuyLineItemsChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
		return new, nil
	case "shipping":
		new := ChangeTargetShippingChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
...
func mapDiscriminatorChangeValueChangeValue(input interface{}) (ChangeValueChangeValue, error) {
	...
	switch discriminator {
	case "absolute":
		new := ChangeValueAbsoluteChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
		return new, nil
	case "external":
		new := ChangeValueExternalChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
		return new, nil
	case "giftLineItem":
		new := ChangeValueGiftLineItemChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
		return new, nil
	case "relative":
		new := ChangeValueRelativeChangeValue{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
...
type ChangeValueGiftLineItemChangeValue struct {
	...
	SupplyChannel       Reference `json:"supplyChannel"`
