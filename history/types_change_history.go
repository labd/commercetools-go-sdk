...
func (obj *Record) UnmarshalJSON(data []byte) error {
	...
	for i := range obj.Stores {
		var err error
		obj.Stores[i], err = mapDiscriminatorKeyReference(obj.Stores[i])
		if err != nil {
			return err
		}
	}
	if obj.BusinessUnit != nil {
		var err error
		obj.BusinessUnit, err = mapDiscriminatorKeyReference(obj.BusinessUnit)
		if err != nil {
			return err
		}
	}
...
const (
	...
	ChangeHistoryResourceTypeShippingMethod   ChangeHistoryResourceType = "shipping-method"
	...
	ChangeHistoryResourceTypeStandalonePrice  ChangeHistoryResourceType = "standalone-price"
...
// UnmarshalJSON override to deserialize correct attribute types based
// on the discriminator value
func (obj *ModifiedBy) UnmarshalJSON(data []byte) error {
	type Alias ModifiedBy
	if err := json.Unmarshal(data, (*Alias)(obj)); err != nil {
		return err
	}
	if obj.Customer != nil {
	...
	if obj.Associate != nil {
		var err error
		obj.Associate, err = mapDiscriminatorReference(obj.Associate)
		if err != nil {
			return err
		}
	}
...
const (
	...
	PlatformInitiatedChangeAddInheritedAssociate        PlatformInitiatedChange = "addInheritedAssociate"
	PlatformInitiatedChangeChangeIncludedInStatistics   PlatformInitiatedChange = "changeIncludedInStatistics"
	PlatformInitiatedChangeChangeInheritedAssociate     PlatformInitiatedChange = "changeInheritedAssociate"
	PlatformInitiatedChangeChangeLastVariantId          PlatformInitiatedChange = "changeLastVariantId"
	PlatformInitiatedChangeChangeLineItemName           PlatformInitiatedChange = "changeLineItemName"
	PlatformInitiatedChangeChangeLineItemPublished      PlatformInitiatedChange = "changeLineItemPublished"
	PlatformInitiatedChangeChangeReviewRatingStatistics PlatformInitiatedChange = "changeReviewRatingStatistics"
	PlatformInitiatedChangeChangeTopLevelUnit           PlatformInitiatedChange = "changeTopLevelUnit"
	PlatformInitiatedChangeRemoveInheritedAssociate     PlatformInitiatedChange = "removeInheritedAssociate"
	PlatformInitiatedChangeSetAncestors                 PlatformInitiatedChange = "setAncestors"
	PlatformInitiatedChangeSetApplicationVersion        PlatformInitiatedChange = "setApplicationVersion"
	PlatformInitiatedChangeSetInheritedAssociates       PlatformInitiatedChange = "setInheritedAssociates"
	PlatformInitiatedChangeSetInheritedStores           PlatformInitiatedChange = "setInheritedStores"
	PlatformInitiatedChangeSetIsValid                   PlatformInitiatedChange = "setIsValid"
	PlatformInitiatedChangeSetLineItemDeactivatedAt     PlatformInitiatedChange = "setLineItemDeactivatedAt"
	PlatformInitiatedChangeSetProductCount              PlatformInitiatedChange = "setProductCount"
	PlatformInitiatedChangeSetReservations              PlatformInitiatedChange = "setReservations"
...
const (
	...
	UpdateTypeAddShipping                                 UpdateType = "addShipping"
	UpdateTypeAddShippingAddressId                        UpdateType = "addShippingAddressId"
	UpdateTypeAddShippingRate                             UpdateType = "addShippingRate"
	...
	UpdateTypeAddZone                                     UpdateType = "addZone"
	UpdateTypeChangeActive                                UpdateType = "changeActive"
	UpdateTypeChangeAddress                               UpdateType = "changeAddress"
	UpdateTypeChangeAmountPlanned                         UpdateType = "changeAmountPlanned"
	UpdateTypeChangeApprovalRuleMode                      UpdateType = "changeApprovalRuleMode"
	...
	UpdateTypeChangeCustomLineItemPriceRoundingMode       UpdateType = "changeCustomLineItemPriceRoundingMode"
	UpdateTypeChangeCustomLineItemQuantity                UpdateType = "changeCustomLineItemQuantity"
	UpdateTypeChangeCustomer                              UpdateType = "changeCustomer"
	UpdateTypeChangeDescription                           UpdateType = "changeDescription"
	UpdateTypeChangeDiscountTypeCombination               UpdateType = "changeDiscountTypeCombination"
	...
	UpdateTypeChangeIncludedInStatistics                  UpdateType = "changeIncludedInStatistics"
	...
	UpdateTypeChangeIsDefault                             UpdateType = "changeIsDefault"
	...
	UpdateTypeChangeLastVariantId                         UpdateType = "changeLastVariantId"
	UpdateTypeChangeLineItemName                          UpdateType = "changeLineItemName"
	UpdateTypeChangeLineItemPriceRoundingMode             UpdateType = "changeLineItemPriceRoundingMode"
	UpdateTypeChangeLineItemPublished                     UpdateType = "changeLineItemPublished"
	...
	UpdateTypeChangePriceRoundingMode                     UpdateType = "changePriceRoundingMode"
	...
	UpdateTypeChangeTaxCategory                           UpdateType = "changeTaxCategory"
	...
	UpdateTypeChangeTopLevelUnit                          UpdateType = "changeTopLevelUnit"
	...
	UpdateTypeExcludeProduct                              UpdateType = "excludeProduct"
	...
	UpdateTypeRemoveShipping                              UpdateType = "removeShipping"
	UpdateTypeRemoveShippingAddressId                     UpdateType = "removeShippingAddressId"
	UpdateTypeRemoveShippingRate                          UpdateType = "removeShippingRate"
	...
	UpdateTypeRemoveZone                                  UpdateType = "removeZone"
	UpdateTypeReplaceTaxRate                              UpdateType = "replaceTaxRate"
	UpdateTypeRequestQuoteRenegotiation                   UpdateType = "requestQuoteRenegotiation"
	UpdateTypeRevertStagedChanges                         UpdateType = "revertStagedChanges"
	UpdateTypeRevertStagedVariantChanges                  UpdateType = "revertStagedVariantChanges"
	...
	UpdateTypeSetAncestors                                UpdateType = "setAncestors"
	...
	UpdateTypeSetAssociates                               UpdateType = "setAssociates"
	...
	UpdateTypeSetBillingAddressCustomField                UpdateType = "setBillingAddressCustomField"
	UpdateTypeSetBillingAddressCustomType                 UpdateType = "setBillingAddressCustomType"
	UpdateTypeSetBusinessUnit                             UpdateType = "setBusinessUnit"
	...
	UpdateTypeSetCustomLineItemDiscountedPrice            UpdateType = "setCustomLineItemDiscountedPrice"
	UpdateTypeSetCustomLineItemDiscountedPricePerQuantity UpdateType = "setCustomLineItemDiscountedPricePerQuantity"
	...
	UpdateTypeSetCustomerGroupAssignments                 UpdateType = "setCustomerGroupAssignments"
	...
	UpdateTypeSetDeliveryAddressCustomField               UpdateType = "setDeliveryAddressCustomField"
	UpdateTypeSetDeliveryAddressCustomType                UpdateType = "setDeliveryAddressCustomType"
	UpdateTypeSetDeliveryCustomField                      UpdateType = "setDeliveryCustomField"
	UpdateTypeSetDeliveryCustomType                       UpdateType = "setDeliveryCustomType"
	UpdateTypeSetDeliveryItems                            UpdateType = "setDeliveryItems"
	UpdateTypeSetDescription                              UpdateType = "setDescription"
	UpdateTypeSetDirectDiscounts                          UpdateType = "setDirectDiscounts"
	UpdateTypeSetDiscountOnTotalPrice                     UpdateType = "setDiscountOnTotalPrice"
	...
	UpdateTypeSetInheritedAssociates                      UpdateType = "setInheritedAssociates"
	UpdateTypeSetInheritedStores                          UpdateType = "setInheritedStores"
	...
	UpdateTypeSetItemShippingAddressCustomField           UpdateType = "setItemShippingAddressCustomField"
	UpdateTypeSetItemShippingAddressCustomType            UpdateType = "setItemShippingAddressCustomType"
	...
	UpdateTypeSetLocalizedDescription                     UpdateType = "setLocalizedDescription"
	UpdateTypeSetLocalizedName                            UpdateType = "setLocalizedName"
	...
	UpdateTypeSetMaxCartQuantity                          UpdateType = "setMaxCartQuantity"
	...
	UpdateTypeSetMinCartQuantity                          UpdateType = "setMinCartQuantity"
	...
	UpdateTypeSetParcelCustomField                        UpdateType = "setParcelCustomField"
	UpdateTypeSetParcelCustomType                         UpdateType = "setParcelCustomType"
	...
	UpdateTypeSetPredicate                                UpdateType = "setPredicate"
	UpdateTypeSetPriceKey                                 UpdateType = "setPriceKey"
	UpdateTypeSetPriceMode                                UpdateType = "setPriceMode"
	UpdateTypeSetPriceTiers                               UpdateType = "setPriceTiers"
	UpdateTypeSetPrices                                   UpdateType = "setPrices"
	UpdateTypeSetProductAttribute                         UpdateType = "setProductAttribute"
	...
	UpdateTypeSetReferences                               UpdateType = "setReferences"
	UpdateTypeSetReservations                             UpdateType = "setReservations"
	UpdateTypeSetRestockableInDays                        UpdateType = "setRestockableInDays"
	UpdateTypeSetReturnInfo                               UpdateType = "setReturnInfo"
	UpdateTypeSetReturnItemCustomField                    UpdateType = "setReturnItemCustomField"
	UpdateTypeSetReturnItemCustomType                     UpdateType = "setReturnItemCustomType"
	...
	UpdateTypeSetShippingAddressCustomField               UpdateType = "setShippingAddressCustomField"
	UpdateTypeSetShippingAddressCustomType                UpdateType = "setShippingAddressCustomType"
	UpdateTypeSetShippingCustomField                      UpdateType = "setShippingCustomField"
	UpdateTypeSetShippingCustomType                       UpdateType = "setShippingCustomType"
	UpdateTypeSetShippingInfoDiscountedPrice              UpdateType = "setShippingInfoDiscountedPrice"
	...
	UpdateTypeSetShippingMethodTaxCategory                UpdateType = "setShippingMethodTaxCategory"
	...
	UpdateTypeSetTaxedShippingPrice                       UpdateType = "setTaxedShippingPrice"
	...
	UpdateTypeSetTransactionCustomField                   UpdateType = "setTransactionCustomField"
	UpdateTypeSetTransactionCustomType                    UpdateType = "setTransactionCustomType"
	UpdateTypeSetTransitions                              UpdateType = "setTransitions"
	UpdateTypeSetUnitType                                 UpdateType = "setUnitType"
	...
	UpdateTypeSetVariantExclusion                         UpdateType = "setVariantExclusion"
