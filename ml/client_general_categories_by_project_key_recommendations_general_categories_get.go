...
func (input *ByProjectKeyRecommendationsGeneralCategoriesRequestMethodGetInput) Values() url.Values {
	...
	if input.ProductImageUrl != nil {
		values.Add("productImageUrl", *input.ProductImageUrl)
	}
	values.Add("productName", input.ProductName)
	if input.Limit != nil {
...
*
 */
func (rb *ByProjectKeyRecommendationsGeneralCategoriesRequestMethodGet) Execute() (result *GeneralCategoryRecommendationPagedQueryResponse, err error) {
