...
type ImportOperation struct {
	...
	ImportSinkKey string `json:"importSinkKey"`
	...
	UnresolvedReferences []KeyReference `json:"unresolvedReferences,omitEmpty"`
...
const (
	ImportOperationStateUnresolved       ImportOperationState = "Unresolved"
