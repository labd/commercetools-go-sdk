 ...
 */
func (rb *ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportOperationsRequestMethodGet) Execute() (result *ImportOperationPagedResponse, err error) {
