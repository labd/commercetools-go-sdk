...
func mapDiscriminatorAttribute(input interface{}) (Attribute, error) {
	...
	case "lenum":
		...
		return new, nil
	case "lenum-set":
		new := LocalizableEnumSetAttribute{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
	...
	case "ltext":
		...
		return new, nil
	case "ltext-set":
		new := LocalizableTextSetAttribute{}
		err := decodeStruct(input, &new)
		if err != nil {
			return nil, err
		}
