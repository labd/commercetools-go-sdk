...
func (rb *ByProjectKeyStagedQuotesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyStagedQuotesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyStagedQuotesByIDRequestMethodHead) Execute(ctx context.Context) error {
