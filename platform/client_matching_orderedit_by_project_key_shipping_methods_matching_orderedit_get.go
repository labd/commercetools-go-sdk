...
func (input *ByProjectKeyShippingMethodsMatchingOrdereditRequestMethodGetInput) Values() url.Values {
	values := url.Values{}
	values.Add("orderEditId", input.OrderEditId)
...
func (rb *ByProjectKeyShippingMethodsMatchingOrdereditRequestMethodGet) Execute() (result *ShippingMethodPagedQueryResponse, err error) {
