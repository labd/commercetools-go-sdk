...
func (rb *ByProjectKeyOrdersByIDRequestMethodPost) Expand(v []string) *ByProjectKeyOrdersByIDRequestMethodPost {
	if rb.params == nil {
		rb.params = &ByProjectKeyOrdersByIDRequestMethodPostInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyOrdersByIDRequestMethodPost) WithHeaders(headers http.Header) *ByProjectKeyOrdersByIDRequestMethodPost {
	rb.headers = headers
	return rb
}
