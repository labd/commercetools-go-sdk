...
func (r *ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetRequestMethodPost) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetRequestMethodPost) WithHeaders(headers http.Header) *ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetRequestMethodPost {
	rb.headers = headers
	return rb
}
