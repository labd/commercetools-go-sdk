...
func (rb *ByProjectKeyCustomersByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCustomersByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyCustomersByIDRequestMethodHead) Execute(ctx context.Context) error {
