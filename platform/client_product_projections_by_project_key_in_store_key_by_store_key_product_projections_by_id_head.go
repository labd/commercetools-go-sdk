...
func (r *ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
