...
func (rb *ByProjectKeyMePaymentsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyMePaymentsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyMePaymentsByIDRequestMethodHead) Execute(ctx context.Context) error {
