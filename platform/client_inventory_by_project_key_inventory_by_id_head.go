...
func (rb *ByProjectKeyInventoryByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyInventoryByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyInventoryByIDRequestMethodHead) Execute(ctx context.Context) error {
