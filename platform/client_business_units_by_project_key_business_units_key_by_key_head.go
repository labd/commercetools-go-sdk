...
func (r *ByProjectKeyBusinessUnitsKeyByKeyRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyBusinessUnitsKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyBusinessUnitsKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
