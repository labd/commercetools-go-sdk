...
func (rb *ByProjectKeyExtensionsKeyByKeyRequestMethodPost) Expand(v []string) *ByProjectKeyExtensionsKeyByKeyRequestMethodPost {
	if rb.params == nil {
		rb.params = &ByProjectKeyExtensionsKeyByKeyRequestMethodPostInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyExtensionsKeyByKeyRequestMethodPost) WithHeaders(headers http.Header) *ByProjectKeyExtensionsKeyByKeyRequestMethodPost {
	rb.headers = headers
	return rb
}
func (rb *ByProjectKeyExtensionsKeyByKeyRequestMethodPost) Execute(ctx context.Context) (result *Extension, err error) {
