...
func (rb *ByProjectKeyShippingMethodsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyShippingMethodsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyShippingMethodsByIDRequestMethodHead) Execute(ctx context.Context) error {
