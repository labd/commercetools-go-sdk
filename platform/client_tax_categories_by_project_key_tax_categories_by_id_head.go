...
func (rb *ByProjectKeyTaxCategoriesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyTaxCategoriesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyTaxCategoriesByIDRequestMethodHead) Execute(ctx context.Context) error {
