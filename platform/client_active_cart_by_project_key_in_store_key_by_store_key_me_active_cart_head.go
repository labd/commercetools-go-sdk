...
func (r *ByProjectKeyInStoreKeyByStoreKeyMeActiveCartRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyInStoreKeyByStoreKeyMeActiveCartRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyInStoreKeyByStoreKeyMeActiveCartRequestMethodHead {
	rb.headers = headers
	return rb
}
