...
func (rb *ByProjectKeyCustomersKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCustomersKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyCustomersKeyByKeyRequestMethodHead) Execute(ctx context.Context) error {
