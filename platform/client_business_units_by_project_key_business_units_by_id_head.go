...
func (rb *ByProjectKeyBusinessUnitsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyBusinessUnitsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyBusinessUnitsByIDRequestMethodHead) Execute(ctx context.Context) error {
