...
func (rb *ByProjectKeyProductDiscountsByIDRequestMethodPost) Expand(v []string) *ByProjectKeyProductDiscountsByIDRequestMethodPost {
	if rb.params == nil {
		rb.params = &ByProjectKeyProductDiscountsByIDRequestMethodPostInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyProductDiscountsByIDRequestMethodPost) WithHeaders(headers http.Header) *ByProjectKeyProductDiscountsByIDRequestMethodPost {
	rb.headers = headers
	return rb
}
