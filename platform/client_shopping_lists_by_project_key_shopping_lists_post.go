...
func (rb *ByProjectKeyShoppingListsRequestMethodPost) Expand(v []string) *ByProjectKeyShoppingListsRequestMethodPost {
	if rb.params == nil {
		rb.params = &ByProjectKeyShoppingListsRequestMethodPostInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyShoppingListsRequestMethodPost) WithHeaders(headers http.Header) *ByProjectKeyShoppingListsRequestMethodPost {
	rb.headers = headers
	return rb
}
