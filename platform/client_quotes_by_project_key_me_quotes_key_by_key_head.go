...
func (rb *ByProjectKeyMeQuotesKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyMeQuotesKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyMeQuotesKeyByKeyRequestMethodHead) Execute(ctx context.Context) error {
