...
func (rb *ByProjectKeyCartDiscountsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCartDiscountsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyCartDiscountsByIDRequestMethodHead) Execute(ctx context.Context) error {
