...
func (rb *ByProjectKeyTypesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyTypesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyTypesByIDRequestMethodHead) Execute(ctx context.Context) error {
