...
func (rb *ByProjectKeyZonesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyZonesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyZonesByIDRequestMethodHead) Execute(ctx context.Context) error {
