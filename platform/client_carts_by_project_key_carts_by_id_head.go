...
func (rb *ByProjectKeyCartsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCartsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyCartsByIDRequestMethodHead) Execute(ctx context.Context) error {
