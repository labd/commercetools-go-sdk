...
func (rb *ByProjectKeyCartsKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCartsKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyCartsKeyByKeyRequestMethodHead) Execute(ctx context.Context) error {
