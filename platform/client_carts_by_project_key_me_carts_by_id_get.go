...
func (rb *ByProjectKeyMeCartsByIDRequestMethodGet) Expand(v []string) *ByProjectKeyMeCartsByIDRequestMethodGet {
	if rb.params == nil {
		rb.params = &ByProjectKeyMeCartsByIDRequestMethodGetInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyMeCartsByIDRequestMethodGet) WithHeaders(headers http.Header) *ByProjectKeyMeCartsByIDRequestMethodGet {
	rb.headers = headers
	return rb
}
