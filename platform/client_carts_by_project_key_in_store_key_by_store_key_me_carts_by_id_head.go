...
func (r *ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
