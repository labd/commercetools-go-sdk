...
func (rb *ByProjectKeyStatesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyStatesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyStatesByIDRequestMethodHead) Execute(ctx context.Context) error {
