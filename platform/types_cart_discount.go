...
type CartDiscount struct {
	...
	RecurringOrderScope RecurringOrderScope `json:"recurringOrderScope"`
}
...
func (obj *CartDiscount) UnmarshalJSON(data []byte) error {
	...
	if obj.RecurringOrderScope != nil {
		var err error
		obj.RecurringOrderScope, err = mapDiscriminatorRecurringOrderScope(obj.RecurringOrderScope)
		if err != nil {
			return err
		}
	}
...
type CartDiscountDraft struct {
	...
	RecurringOrderScope RecurringOrderScopeDraft `json:"recurringOrderScope,omitempty"`
}
...
func (obj *CartDiscountDraft) UnmarshalJSON(data []byte) error {
	...
	if obj.RecurringOrderScope != nil {
		var err error
		obj.RecurringOrderScope, err = mapDiscriminatorRecurringOrderScopeDraft(obj.RecurringOrderScope)
		if err != nil {
			return err
		}
	}
...
func mapDiscriminatorCartDiscountUpdateAction(input interface{}) (CartDiscountUpdateAction, error) {
	...
	case "setRecurringOrderScope":
		obj := CartDiscountSetRecurringOrderScopeAction{}
		if err := decodeStruct(input, &obj); err != nil {
			return nil, err
		}
		if obj.RecurringOrderScope != nil {
...
*
 */
type CartDiscountSetRecurringOrderScopeAction struct {
	// Scope of the Cart Discount for Recurring Orders.
	RecurringOrderScope RecurringOrderScopeDraft `json:"recurringOrderScope"`
}

// UnmarshalJSON override to deserialize correct attribute types based
// on the discriminator value
func (obj *CartDiscountSetRecurringOrderScopeAction) UnmarshalJSON(data []byte) error {
	type Alias CartDiscountSetRecurringOrderScopeAction
	if err := json.Unmarshal(data, (*Alias)(obj)); err != nil {
		return err
	}
	if obj.RecurringOrderScope != nil {
...
// MarshalJSON override to set the discriminator value or remove
// optional nil slices
func (obj CartDiscountSetRecurringOrderScopeAction) MarshalJSON() ([]byte, error) {
	type Alias CartDiscountSetRecurringOrderScopeAction
	return json.Marshal(struct {
		Action string `json:"action"`
		*Alias
	}{Action: "setRecurringOrderScope", Alias: (*Alias)(&obj)})
}
