...
func (rb *ByProjectKeyQuoteRequestsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyQuoteRequestsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyQuoteRequestsByIDRequestMethodHead) Execute(ctx context.Context) error {
