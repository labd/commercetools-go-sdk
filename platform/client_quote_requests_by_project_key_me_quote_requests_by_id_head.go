...
func (rb *ByProjectKeyMeQuoteRequestsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyMeQuoteRequestsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyMeQuoteRequestsByIDRequestMethodHead) Execute(ctx context.Context) error {
