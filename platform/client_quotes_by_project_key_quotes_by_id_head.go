...
func (rb *ByProjectKeyQuotesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyQuotesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyQuotesByIDRequestMethodHead) Execute(ctx context.Context) error {
