...
func (rb *ByProjectKeyCategoriesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCategoriesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyCategoriesByIDRequestMethodHead) Execute(ctx context.Context) error {
