...
func (rb *ByProjectKeyMessagesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyMessagesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyMessagesByIDRequestMethodHead) Execute(ctx context.Context) error {
