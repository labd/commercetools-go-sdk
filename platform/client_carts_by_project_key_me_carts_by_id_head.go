...
func (rb *ByProjectKeyMeCartsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyMeCartsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
...
*
 */
func (rb *ByProjectKeyMeCartsByIDRequestMethodHead) Execute(ctx context.Context) error {
