...
func (rb *ByProjectKeyPaymentsByIDRequestMethodGet) Expand(v []string) *ByProjectKeyPaymentsByIDRequestMethodGet {
	if rb.params == nil {
		rb.params = &ByProjectKeyPaymentsByIDRequestMethodGetInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyPaymentsByIDRequestMethodGet) WithHeaders(headers http.Header) *ByProjectKeyPaymentsByIDRequestMethodGet {
	rb.headers = headers
	return rb
}
