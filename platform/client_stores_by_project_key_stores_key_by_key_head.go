...
func (rb *ByProjectKeyStoresKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyStoresKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyStoresKeyByKeyRequestMethodHead) Execute(ctx context.Context) error {
