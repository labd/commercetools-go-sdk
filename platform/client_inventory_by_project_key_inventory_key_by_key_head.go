...
func (rb *ByProjectKeyInventoryKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyInventoryKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyInventoryKeyByKeyRequestMethodHead) Execute(ctx context.Context) error {
