...
func (r *ByProjectKeyMeBusinessUnitsKeyByKeyRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyMeBusinessUnitsKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyMeBusinessUnitsKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
