...
func (input *ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartRequestMethodGetInput) Values() url.Values {
	values := url.Values{}
	values.Add("cartId", input.CartId)
	if input.Expand != nil {
...
func (rb *ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartRequestMethodGet) Execute() (result *ShippingMethodPagedQueryResponse, err error) {
