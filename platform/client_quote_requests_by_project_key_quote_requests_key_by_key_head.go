...
func (r *ByProjectKeyQuoteRequestsKeyByKeyRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyQuoteRequestsKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyQuoteRequestsKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
