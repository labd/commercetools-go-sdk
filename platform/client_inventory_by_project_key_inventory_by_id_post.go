...
func (rb *ByProjectKeyInventoryByIDRequestMethodPost) Expand(v []string) *ByProjectKeyInventoryByIDRequestMethodPost {
	if rb.params == nil {
		rb.params = &ByProjectKeyInventoryByIDRequestMethodPostInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyInventoryByIDRequestMethodPost) WithHeaders(headers http.Header) *ByProjectKeyInventoryByIDRequestMethodPost {
	rb.headers = headers
	return rb
}
