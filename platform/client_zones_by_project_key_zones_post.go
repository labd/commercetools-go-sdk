...
func (rb *ByProjectKeyZonesRequestMethodPost) Expand(v []string) *ByProjectKeyZonesRequestMethodPost {
	if rb.params == nil {
		rb.params = &ByProjectKeyZonesRequestMethodPostInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyZonesRequestMethodPost) WithHeaders(headers http.Header) *ByProjectKeyZonesRequestMethodPost {
	rb.headers = headers
	return rb
}
