...
func (rb *ByProjectKeyDiscountCodesByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyDiscountCodesByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyDiscountCodesByIDRequestMethodHead) Execute(ctx context.Context) error {
