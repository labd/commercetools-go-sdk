...
func (rb *ByProjectKeyPaymentsByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyPaymentsByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyPaymentsByIDRequestMethodHead) Execute(ctx context.Context) error {
