...
func (r *ByProjectKeyCartsCustomerIdByCustomerIdRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyCartsCustomerIdByCustomerIdRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCartsCustomerIdByCustomerIdRequestMethodHead {
	rb.headers = headers
	return rb
}
