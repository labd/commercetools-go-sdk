...
func (rb *ByProjectKeyQuotesKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyQuotesKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
 ...
 */
func (rb *ByProjectKeyQuotesKeyByKeyRequestMethodHead) Execute(ctx context.Context) error {
