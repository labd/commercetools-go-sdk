...
func (rb *ByProjectKeyStatesKeyByKeyRequestMethodGet) Expand(v []string) *ByProjectKeyStatesKeyByKeyRequestMethodGet {
	if rb.params == nil {
		rb.params = &ByProjectKeyStatesKeyByKeyRequestMethodGetInput{}
	}
	rb.params.Expand = v
	return rb
}
...
func (rb *ByProjectKeyStatesKeyByKeyRequestMethodGet) WithHeaders(headers http.Header) *ByProjectKeyStatesKeyByKeyRequestMethodGet {
	rb.headers = headers
	return rb
}
