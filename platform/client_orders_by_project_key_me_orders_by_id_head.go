...
func (rb *ByProjectKeyMeOrdersByIDRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyMeOrdersByIDRequestMethodHead {
	rb.headers = headers
	return rb
}
...
*
 */
func (rb *ByProjectKeyMeOrdersByIDRequestMethodHead) Execute(ctx context.Context) error {
