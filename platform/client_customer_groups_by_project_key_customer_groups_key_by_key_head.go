...
func (r *ByProjectKeyCustomerGroupsKeyByKeyRequestMethodHead) Dump() map[string]interface{} {
	return map[string]interface{}{
		"url": r.url,
	}
}

func (rb *ByProjectKeyCustomerGroupsKeyByKeyRequestMethodHead) WithHeaders(headers http.Header) *ByProjectKeyCustomerGroupsKeyByKeyRequestMethodHead {
	rb.headers = headers
	return rb
}
